...
<div class="container-fluid">
    ...
    <div class="row mt-3">
        <div class="col-lg-4">
            <a href="http://localhost/pp2/supervisor/Pantalla_supervisores.php" class="panel-link">
                <div class="panel">
                    <div class="panel-body-3">
                        ...
                        echo "<h5 class='titulo-tarjeta'>Supervisores</h5><h3 class='font-weight-bold'>" . mysqli_num_rows($resultado) . "</h3>";
                        ?>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-check" viewBox="0 0 16 16">
                            <path d="M15.854 5.146a.5.5 0 0 0-.708 0L10.5 9.793 8.354 7.646a.5.5 0 1 0-.708.708l2.5 2.5a.5.5 0 0 0 .708 0l5-5a.5.5 0 0 0 0-.708z"/>
        ...
        <div class="col-lg-4">
            <a href="http://localhost/pp2/vendedores/Pantalla_empleados.php" class="panel-link">
                <div class="panel">
                    <div class="panel-body-3">
                        <?php
        ...
        <div class="col-lg-4">
            <a href="http://localhost/pp2/clientes/Pantalla_clientes.php" class="panel-link">
                <div class="panel">
                    <div class="panel-body-3">
                        <?php
