...
<div class="main p-3 ms-5">
    ...
    <form method="get" action="Pantalla_ventas.php" class="mb-3">
        <div class="input-group">
            <input type="text" class="form-control" name="search" placeholder="Buscar por nombre de producto, cliente o vendedor" value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
    ...
    $search_query = $search ? "WHERE productos.nombre LIKE '%$search%' OR clientes.nombre LIKE '%$search%' OR empleados.nombre LIKE '%$search%'" : '';
