    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editarClienteForm" action="procesarCliente.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="empresa_editar" class="form-label">Empresa</label>
                        <input type="text" class="form-control" id="empresa_editar" name="empresa" required>
                    </div>
                    <div class="mb-3">
