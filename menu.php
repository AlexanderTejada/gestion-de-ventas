...
<div class="wrapper d-flex">
    <aside id="sidebar" style="border-top-right-radius: 50px;">
        <div class="d-flex">
            ...
            <div class="sidebar-logo">
                <a href="http://localhost/pp2/index.php">Gestion de ventas</a>
            </div>
        </div>
        <ul class="sidebar-nav">
            <li class="sidebar-item">
                <a href="http://localhost/pp2/supervisor/Pantalla_supervisores.php" class="sidebar-link">
                    <i class="lni lni-users"></i>
                    <span>Supervisores</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="http://localhost/pp2/vendedores/Pantalla_empleados.php" class="sidebar-link">
                    <i class="lni lni-cart"></i>
                    <span>Vendedores</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="http://localhost/pp2/clientes/Pantalla_clientes.php" class="sidebar-link">
                    <i class="lni lni-users"></i>
                    <span>Clientes</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="http://localhost/pp2/productos/Pantalla_productos.php" class="sidebar-link">
                    <i class="lni lni-package"></i>
                    <span>Productos</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="http://localhost/pp2/ventas/Pantalla_ventas.php" class="sidebar-link">
                    <i class="lni lni-money-location"></i>
                    <span>Ventas</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="http://localhost/pp2/premios/Pantalla_premios.php" class="sidebar-link">
                    <i class="lni lni-certificate"></i>
                    <span>Premios</span>
                </a>
            </li>
            <li class="sidebar-item">
    <a href="http://localhost/pp2/usuarios/Pantalla_usuarios.php" class="sidebar-link">
        <i class="lni lni-users"></i>
        <span>Usuarios</span>
    </a>
</li>
    ...
    <div class="main p-4 ms-0">
        ...
        <div class="container-fluid">
            <h1><a href="http://localhost/pp2/" class="nombre-usuario">Panel</a></h1>
