...
<div class="wrapper d-flex">
    <aside id="sidebar" style="border-top-right-radius: 50px;">
        <div class="d-flex">
            ...
            <div class="sidebar-logo">
                <a href="http://localhost/pp2/indexVendedor.php">Gestion de ventas</a>
            </div>
        </div>
       
         
            <li class="sidebar-item">
                <a href="http://localhost/pp2/clientes/Pantalla_clientes_vendedor.php" class="sidebar-link">
                    <i class="lni lni-users"></i>
                    <span>Clientes</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="http://localhost/pp2/productos/Pantalla_productos_vendedor.php" class="sidebar-link">
                    <i class="lni lni-package"></i>
                    <span>Productos</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="http://localhost/pp2/ventas/Pantalla_ventas_vendedor.php" class="sidebar-link">
                    <i class="lni lni-money-location"></i>
                    <span>Ventas</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="http://localhost/pp2/premios/Pantalla_premios_vendedor.php" class="sidebar-link">
    ...
    <div class="main p-4 ms-0">
        ...
        <div class="container-fluid">
            <h1><a href="http://localhost/pp2/indexVendedor.php" class="nombre-usuario">Panel Vendedor</a></h1>
